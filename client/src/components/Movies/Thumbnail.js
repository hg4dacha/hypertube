...
const Thumbnail = ({lastMovieElementRef, id, title, picture, year, rating, vue }) => {
    ...
    return(
        <div ref={lastMovieElementRef} className={`thumbnail-container ${thumbnailZoom ? "zoom" : ""}`} onMouseOver={handleZoom} onMouseOut={handleZoomOut} >
            <Link to={id}>
